...
class phoneForm extends React.Component {
    ...
    handleSubmit = (e) => {
        const {handleForgetPhone} = this.props;
        e.preventDefault();
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                handleForgetPhone(values.phone);
                return this.context.router.push('/account/forgetPass');
            }
        });
    };
...
const PhoneVerify = Form.create()(phoneForm);
